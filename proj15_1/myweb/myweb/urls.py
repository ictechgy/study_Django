...
urlpatterns = [
    url(r'^account/', include('django.contrib.auth.urls')),#name 쓸 필요 없음. 장고 기본 기능 사용할 것
    ...
    #/account/logout/ 또는 {% url 'logout' %}을 하면 로그아웃이 자동으로 이루어지고 loged_out.html 파일로 연결이 된다.
